...
const messages = [
	...
	"Hi, {name}. I'm Egor, well-versed in the front end development, with a flair for design and back end. In my quest for fresh opportunities and expanding my professional network, I'm eager to link up with you. Your skill in recruitment could offer key insights as I shape my career path.",
];
